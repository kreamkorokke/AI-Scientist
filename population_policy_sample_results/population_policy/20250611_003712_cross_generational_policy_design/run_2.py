...
class PolicyEffectsCalculator:
    ...
    def __init__(self, sensitivity: float = 1.0):
        ...
        self.migration_effects = {
            ...
            'work_life_balance_index': [1.0, 1.0, 1.08, 1.20, 1.15, 1.10, 1.05, 1.02, 1.01] + [1.0] * 12,  # Better work integration through mentoring
