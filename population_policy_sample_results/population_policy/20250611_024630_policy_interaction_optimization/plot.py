...
labels = {
    "run_0": "Baseline Run",
    "run_1": "Child Allowance + Childcare Analysis",
    "run_2": "Immigration + Regional Development Analysis", 
    "run_3": "Work-Life Balance + Parental Leave Analysis",
    "run_4": "Housing + Tax Incentives Analysis"
}
